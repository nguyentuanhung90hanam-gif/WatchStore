...
<div class="container">
    ...
    <div class="box">
        ...
        <form method="post" action="${pageContext.request.contextPath}/manage/sales/order-add">

            <div class="form-grid">

                <div class="form-group">
                    <label for="customerName">Tên khách hàng <span class="required-mark">*</span></label>
                    <input type="text" id="customerName" name="customerName" placeholder="Nhập tên người nhận" required>
                </div>

                <div class="form-group">
                    <label for="phone">Số điện thoại <span class="required-mark">*</span></label>
                    <input type="tel" id="phone" name="phone" placeholder="Ví dụ: 0988666888" required>
                </div>

                <div class="form-group full">
                    <label for="shippingAddress">Địa chỉ giao hàng <span class="required-mark">*</span></label>
                    <input type="text" id="shippingAddress" name="shippingAddress" placeholder="Số nhà, đường, quận/huyện, tỉnh/thành phố..." required>
                </div>

                <div class="form-group">
                    <label for="totalPrice">Tổng tiền đơn hàng (đ) <span class="required-mark">*</span></label>
                    <input type="number" id="totalPrice" name="totalPrice" placeholder="Ví dụ: 6500000" min="0" required>
                </div>

                <div class="form-group">
                    <label for="status">Trạng thái ban đầu <span class="required-mark">*</span></label>
