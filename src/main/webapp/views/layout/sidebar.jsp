...
<aside class="portal-sidebar" data-sidebar>
    ...
    <div class="portal-user">
        ...
        <span>
            ...
            <small>${empty sessionScope.user ? 'ADMIN' : sessionScope.user.roleLabel}</small>
        </span>
    </div>
    <nav>
        <c:choose>
        ...
        <div style="margin-top: 15px; padding: 8px 12px 4px 12px; font-size: 11px; font-weight: 700; color: #888; text-transform: uppercase; letter-spacing: 0.5px;">TÀI KHOẢN</div>
